...
client.once('ready', () => {
	console.log('WellBot est en ligne !');
...
client.on('interactionCreate', async interaction => {
	if (!interaction.isCommand() || !interaction.member.permissions.has('ADMINISTRATOR')) return await interaction.reply({ content: 'Vous n\'avez pas accès à cette commande.', ephemeral: true });
